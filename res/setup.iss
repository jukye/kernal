...
DefaultDirName={userdesktop}\{#pappId}-portable
CreateAppDir=yes
Uninstallable=no
PrivilegesRequired=lowest
ArchitecturesAllowed=@ISS_ARCH@

VersionInfoDescription={#pappName}
VersionInfoCompany={#pappPublisher}
VersionInfoCopyright={#pappCopyright}
VersionInfoVersion={#pappVersion}
